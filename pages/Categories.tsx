...
export default function Categories({ addToCart }: CategoriesProps) {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_rgba(59,130,246,0.04),_transparent_60%),linear-gradient(to_bottom,#fafbff,#ffffff)]">
      ...
      <div className="max-w-full mx-auto px-4 sm:px-10 lg:px-20 pt-24">
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">

       <h1 className="text-[42px] font-extrabold tracking-tight text-slate-900">
...
{/* <p className="mt-2 text-lg text-slate-500 max-w-xl">
          ...
          <div className="flex items-center gap-6 w-full md:w-auto">
            <div className="relative" ref={filterPanelRef}>
              <button 
                ...
                className={`flex items-center gap-4 font-black px-8 py-4 rounded-[1.5rem] border transition-all ${
                  isFilterOpen 
              ...
              >
                ...
                <span className="uppercase tracking-widest text-[10px]">Filter: <span className="text-blue-600">{currentCategoryName}</span></span>
              </button>

              {isFilterOpen && (
                <div className="absolute left-0 md:left-auto md:right-0 mt-4 w-72 bg-white rounded-[2rem] shadow-[0_30px_70px_rgba(0,0,0,0.12)] border border-slate-100 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
  ...
  className={
    viewType === 'grid'
      ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12"
      : "space-y-12"
  }
>
...
/>
    ...
    {/* TITLE */}
   {/* TITLE */}
  <h3 className="text-[15px] font-extrabold text-slate-900 uppercase leading-snug mb-3">
    {badge.name}
  </h3>
