...
<div className="pointer-events-none absolute inset-0">
  <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-indigo-500/10 rounded-full blur-[140px]" />
  ...
  Grab them before they disappear into the vault
</p>
...
<div
  onClick={() => setFlippedId(flippedId === badge.id ? null : badge.id)}
...
>
  ...
  alt={badge.name}
 className="
  w-[82%] h-[82%] object-contain mx-auto relative z-10
