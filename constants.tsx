...
export const BADGES: Badge[] = [
  ...
  { id: 'moody-1', name: 'Crushin’', price: 49, category: Category.MOODY, image: 'badge/moody1.png', details: 'Spread pure joy.', color: 'bg-transparent', isFeatured: true },
  { id: 'moody-2', name: 'OMG Mood', price: 49, category: Category.MOODY, image: 'badge/moody3.png', details: 'Feel the love.', color: 'bg-transparent', isFeatured: true },
  { id: 'moody-3', name: 'Just Vibin’', price: 49, category: Category.MOODY, image: 'badge/moody4.png', details: 'Pure comedy gold.', color: 'bg-transparent', isFeatured: true },
  ...
  // --- SPORTS ---
  { id: 'sports-1', name: 'Victory Kick', price: 49, category: Category.SPORTS, image: 'badge/sports4.png', details: 'The cricket spirit.', color: 'bg-transparent', isFeatured: true },
 { id: 'sports-2', name: 'Slam Point', price: 49, category: Category.SPORTS, image: 'badge/sports3.png', details: 'For the football fanatics.', color: 'bg-transparent', isFeatured: true },
...
{ id: 'sports-4', name: 'Power Play', price: 49, category: Category.SPORTS, image: 'badge/sports2.png', details: 'Game, set, match.', color: 'bg-transparent', isFeatured: true },
  ...
  { id: 'spiritual-4', name: 'Sacred Strength', price: 49, category: Category.RELIGIOUS, image: 'badge/R4.png', details: 'Ancient symbols.', color: 'bg-transparent' },
...
, category: Category.ENTERTAINMENT, image: 'badge/entert2.png', details: 'Level up.', color: 'bg-transparent' },
...
// , category: Category.ENTERTAINMENT, image: 'badge/badge6.png', details: 'The night is young.', color: 'bg-transparent' },
  // --- EVENTS ---
  { id: 'event-1', name: 'PARTY VIBE', price: 49, category: Category.EVENTS, image: 'badge/event1.png', details: 'Celebrate big.', color: 'bg-transparent' },
  { id: 'event-2', name: 'UNION VIBE', price: 49, category: Category.EVENTS, image: 'badge/event2.png', details: 'Wedding season.', color: 'bg-transparent' },
  ...
  // { id: 'event-5', name: 'AGE VIBE', price: 49, category: Category.EVENTS, image: 'badge/badge6.png', details: 'Birthday joy.', color: 'bg-transparent' },

  // --- ANIMAL ---
  { id: 'animal-1', name: 'Soft Paws', price: 49, category: Category.ANIMAL, image: 'badge/animal1.png', details: 'Cat lovers only.', color: 'bg-transparent' },
  ...
  { id: 'couple-4', name: 'DATE VIBE', price: 49, category: Category.COUPLE, image: 'badge/c4.png', details: 'Perfect evening.', color: 'bg-transparent' },
...
, category: Category.ANIME, image: 'badge/anime2.png', details: 'Path of the ninja.', color: '' },
